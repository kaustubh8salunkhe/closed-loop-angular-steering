...
**Phase 1: Nuisance Variable Extraction**
Rooted in the Deep Rendering Mixture Model (DRMM), we model safety behaviors and refusal states as latent task nuisance variables. By analyzing the model from a top-down representational view, we extract a one-dimensional "refusal direction" using a difference-in-means calculation over contrastive pairs of harmful and harmless instructions.  
**Phase 2: 2D Steering Plane Construction**
